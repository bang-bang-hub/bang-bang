...
export function WishlistForm({ highlighted }: WishlistFormProps) {
  ...
  return (
    <section
      ...
      className={cn(
        "scroll-mt-24 rounded-2xl bg-white overflow-hidden transition-all max-w-3xl mx-auto",
        highlighted
    ...
    >
      <div
        className="relative flex flex-col md:flex-row md:items-center gap-4 md:gap-6 p-5 md:px-7 md:py-6"
        style={{
          background:
      ...
      >
        <div className="flex flex-col gap-2 md:flex-1 min-w-0">
          <span className="inline-flex self-start items-center gap-1.5 px-2.5 py-1 rounded-full bg-[#E87A1E] text-white text-[10px] font-black uppercase tracking-[0.22em] shadow-[0_6px_14px_-6px_rgba(232,122,30,0.6)]">
          ...
          <h3
            ...
            className="font-black uppercase text-[#1A1A1A] text-xl md:text-2xl leading-[1.05] tracking-tight"
          ...
          <p className="text-[#4A2C1A]/70 leading-snug text-[13px] md:text-sm">
            Não achou Bang Bang aí? Chama no WhatsApp, a gente registra a demanda.
          </p>

          {highlighted && (
            <div className="rounded-lg bg-[#E87A1E]/10 border border-[#E87A1E]/30 text-[#C4650F] px-3 py-2 text-[13px] font-semibold leading-snug">
        ...
        <a
          ...
          className={cn(
            "shrink-0 inline-flex items-center justify-center gap-2 h-11 px-5 rounded-xl whitespace-nowrap",
            "bg-[#E87A1E] text-white font-black text-[12px] uppercase tracking-[0.16em]",
